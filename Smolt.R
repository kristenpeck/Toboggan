...
# CWT retention log ####
CWT24 <- read_excel("toboggan_smolt_dataentry_FINAL 2024-copy19-Jan-2026.xlsx", 
                       sheet="cwt_log") %>% 
...
ave.CWTmeristics24 <- read_excel("toboggan_smolt_dataentry_FINAL 2024-copy19-Jan-2026.xlsx", 
...
fish24 <- read_excel("toboggan_smolt_dataentry_FINAL 2024-copy19-Jan-2026.xlsx", 
                    sheet="individualfish") %>% 
...
CWTretention24raw <- read_excel("toboggan_smolt_dataentry_FINAL 2024-copy19-Jan-2026.xlsx", 
                    sheet="cwt_log") %>% 
